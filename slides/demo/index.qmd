...
::: {.large}
This is a [Quarto](https://quarto.org/) [revealjs](https://revealjs.com) presentation with Tealium theme. This demo showcases the usage and capabilities of this system. Revealjs in Quarto is documented [here](https://quarto.org/docs/presentations/revealjs/).
:::
...
Change title slide background image by setting the following YAML parameters.
